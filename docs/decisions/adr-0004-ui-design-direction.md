...
## Why Limit Navigation To 8 Modules

The 8-module cap keeps mental load manageable and prevents sidebar sprawl. Deeper functions use second-level tabs and right rails.
