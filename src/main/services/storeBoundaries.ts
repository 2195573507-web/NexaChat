...
export const STORE_BOUNDARY_MAP = [
  ...
  { method: 'updateModel', targetService: 'ModelService', currentOwner: 'ModelService', migrationState: 'service-implemented' },
  { method: 'disableModel', targetService: 'ModelService', currentOwner: 'ModelService', migrationState: 'service-implemented' },
  { method: 'enableModel', targetService: 'ModelService', currentOwner: 'ModelService', migrationState: 'service-implemented' },
  { method: 'deleteModel', targetService: 'ModelService', currentOwner: 'ModelService', migrationState: 'service-implemented' },
