...
const api: AppApi = {
  ...
  updateModel: (input: ModelUpdateInput) => invoke(IPC_CHANNELS.modelUpdate, input),
  disableModel: (input: ModelStateInput) => invoke(IPC_CHANNELS.modelDisable, input),
  enableModel: (input: ModelStateInput) => invoke(IPC_CHANNELS.modelEnable, input),
  deleteModel: (input: ModelStateInput) => invoke(IPC_CHANNELS.modelDelete, input),
